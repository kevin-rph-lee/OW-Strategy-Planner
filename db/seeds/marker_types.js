  ...
  return knex('marker_types').del()
    .then(function () {
      return Promise.all([
        ...
        knex('marker_types').insert({title: 'Phara', icon_file_location: 'https://raw.githubusercontent.com/kevin-rph-lee/OWMaps/master/hero_icons/phara_b.png', teammate_icon: true}),
