  ...
  return knex('markers').del()
    .then(function () {
      ...
      return knex('markers').insert([
        {position:{lat: 0, lng: 0}, title: 'Parking Spot', marker_type_id: 1, description: 'test', owner_id: 1, plan_id:1, image: true},
        {position:{lat: 0, lng: 0}, title: 'Parking Spot', marker_type_id: 1, description: 'test', owner_id: 1, plan_id:2, image: false}
